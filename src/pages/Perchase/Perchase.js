    ...
    <div>
      <div className="border border-slate-900/10 rounded shadow-lg p-4 max-w-3xl mx-auto mt-8 flex justify-between gap-6">
        <div className="w-full">
          <h2 className="text-2xl font-bold my-3 border-b border-violet-600 pb-2">
          ...
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="flex items-center border mb-3 gap-2 p-1 rounded shadow-lg"
              >
                <img
                  className="w-12 h-12"
                  src={video.thumbnail}
        ...
        <div className="w-full">
          ...
          <form action="" onSubmit={(e) => handleForm(e)}>
            ...
            <button type="submit" className="btn btn-primary block w-full mt-6">
              <NavLink to="/success">Complete perchase</NavLink>
            </button>
          </form>
        </div>
      </div>
